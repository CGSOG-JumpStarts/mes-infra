...
variable "appServiceSkuSize" {
  description = "The size of the app service plan for the MES website. Must match with the tier value in appServiceSkuTier."
  type = string
  default = "S1"
}

variable "appServiceSkuTier" {
  description = "The tier of the app service plan for the MES website. Must match with the size value in appServiceSkuSize."
  type = string
  default = "Standard"
